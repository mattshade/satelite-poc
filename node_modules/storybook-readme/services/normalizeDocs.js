...
exports.default = function (docs) {
  ...
  return {
    docsBeforePreview: grouped.docsBeforePreview.length === 0 ? null : grouped.docsBeforePreview,
    docsAfterPreview: grouped.docsAfterPreview.length === 0 ? null : grouped.docsAfterPreview
  };
};
